<?php //netteCache[01]000544a:2:{s:4:"time";s:21:"0.57705800 1332964443";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:53:"/srv/http/Projects/nette-adons/app/config/config.neon";i:2;i:1332963949;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:52:"/srv/http/Projects/nette-adons/libs/Nette/loader.php";i:2;i:1330524146;}i:2;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:69:"/srv/http/Projects/nette-adons/app/components/paypal/PayPalButton.php";i:2;i:1332849720;}}}?><?php
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/srv/http/Projects/nette-adons/app',
			'wwwDir' => '/srv/http/Projects/nette-adons/www',
			...
			'tempDir' => '/srv/http/Projects/nette-adons/app/../temp',
			'paypal' => array(
				'api' => array(
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/srv/http/Projects/nette-adons/app/../temp/cache', $this->{'nette.cacheJournal'});
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/srv/http/Projects/nette-adons/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('/srv/http/Projects/nette-adons/app', $this);
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/srv/http/Projects/nette-adons/app/../temp/cache', $this->{'nette.cacheJournal'});
		return $service;
	}
	...
	public function initialize()
	{
		...
		ini_set('session.save_path', '/srv/http/Projects/nette-adons/app/../temp/sessions');
